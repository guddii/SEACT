...
----
 ...
 6. Anforderungen und Konzept
    - Private und offene Netzwerke
    - Multi-Domain-Unterstützung
    - Compliance & Audit
 7. Implementierung
    - Serialisierung von HTTP-Anfragen
    - Integration als Standalone Reverse-Proxy
    - Integration mit existierenden Reverse-Proxies (ngnix and treafik)
 8. Verifikation
 9. Diskussion
10. Zusammenfassung
