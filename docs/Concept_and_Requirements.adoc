...
However, this requires the application to be a Solid application, as it communicates over HTTP APIs with the actual Solid provider.
...
include::Data_Capturing_Strategies.adoc[leveloffset=+3]

include::Ownership_Verification.adoc[leveloffset=+3]
