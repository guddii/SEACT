...
This section illustrates the dynamic behavior of the system's objects using <<UML>> 2.5 with https://plantuml.com/de/[PlantUML] as the generator.
Sequence diagrams and other interaction diagrams (sd) will be used.
Please note that this is a simplified representation of the system's behavior.
It may omit some insignificant details or vary in the actual program code.
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of an authorized CRUD request
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of the log claiming process
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of the discovery of logs
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of the authentication using client credentials
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of the request being forwarded by the proxy
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of the Data Privacy Cockpit middleware
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of the claim data lookup
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of an access log resource update
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of initializing a verification code
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of writing a verification code to the clients' storage
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of writing a verification code to the DPC storage
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1{fn-uml} Sequence diagram of how to get a claimed resource
[.text-center]
[plantuml,format=svg]
....
