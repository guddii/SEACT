...
- The Solid Protocol and related technologies are rather new and under continues improvements.
- Limited visibillity of accessed resources

==== Objectives and Research Interest

- Meta goal ... enhanceing Solid / repeating rutines without touching Solid
