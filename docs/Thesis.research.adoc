...
Ongoing research and development is being conducted to improve the ecosystem, resulting in the regular introduction of new features or <<Solid Provider>>s.
...
All of these achievements should be established in a clear context and communicated through data <<API,APIs>> to ensure safety for new features and potential changes in <<Solid Provider>>s.
