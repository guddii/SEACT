...
Despite the implementation of ten attempts, 20 of the 24 test runs remained unanalyzable due to errors or invalid results.
...
In <<Attempt 10>>, the observed increase in average response times was 0.63 seconds, as shown in column `B` of xref:tbl-test-run-response-times-average[xrefstyle=short].
