...
The specifications included here are only representative of a subset of the definitions relevant to this research, primarily focusing on special http headers, identity, resources, authentication and authorization.
