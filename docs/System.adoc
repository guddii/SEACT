...
This is sometimes referred to as <<ROA>>, as defined by citenp:[richardson_restful_2007]. <<ROA, ROAs>> is designed to facilitate the manipulation of resources through four operations: creation, reading, updating, and deletion (<<CRUD>>).
...
It is important to note that each state of the state machine can be a final state with regard to the process that is the focus of this work.
