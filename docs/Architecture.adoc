...
.<<UML>> 2.5.1footnote:uml[https://www.omg.org/spec/UML/2.5.1] Sequence diagram of the claim data lookup
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1footnote:uml[https://www.omg.org/spec/UML/2.5.1] Sequence diagram of initializing a verification code
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1footnote:uml[https://www.omg.org/spec/UML/2.5.1] Sequence diagram of writing a verification code to the clients' storage
[.text-center]
[plantuml,format=svg]
....
...
.<<UML>> 2.5.1footnote:uml[https://www.omg.org/spec/UML/2.5.1] Sequence diagram of writing a verification code to the DPC storage
[.text-center]
[plantuml,format=svg]
....
